...
function dragDrop () {
    ...
    let lastmove = [];
    let addtomoves = [parseInt(selectedpiece.parentElement.id.split('')[1]), parseInt(selectedpiece.parentElement.id.split('')[0]), 
                        parseInt(this.id.split('')[1]), parseInt(this.id.split('')[0]), selectedpiece.firstChild.className];
    
    pieces.forEach(piece => lastmove.push([piece.parentElement.id.split('')[0], piece.parentElement.id.split('')[1]]));
